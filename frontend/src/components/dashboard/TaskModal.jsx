  ...
  return (
    <div className="fixed inset-0 z-[500] flex justify-end">
      ...
      <motion.div
        ...
        className="relative w-full max-w-xl bg-[#0f172a] shadow-2xl flex flex-col h-full border-l border-slate-800"
      >
        {/* Header Section */}
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full bg-[#020617]/50 border border-slate-800 focus:border-gold-500 rounded-xl pl-12 pr-4 py-4 text-[10px] text-white outline-none transition-all uppercase font-black tracking-widest"
                />
              </div>
              <select 
                value={priority}
              ...
              <div className="bg-[#020617]/50 border border-slate-800 rounded-xl p-3 min-h-[60px] focus-within:border-gold-500 transition-all">
                ...
                <input 
                  ...
                  onChange={e => {
                    ...
                    if (match && !prerequisites.includes(match.name)) {
            ...
            <AnimatePresence mode="popLayout">
              {filteredTasks.map((task, idx) => (
                <motion.div
                  ...
                  className={cn(
                    "relative group bg-slate-900/40 border border-slate-800/60 rounded-2xl p-5 hover:border-gold-500/30 transition-all",
                ...
                >
                  <div className="flex items-start gap-5">
                    ...
                    >
                      {task.status === 'Completed' ? <CheckCircle2 className="w-3.5 h-3.5" /> : <div className="w-1 h-1 rounded-full bg-slate-700" />}
                    </button>
